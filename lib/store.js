...
export function storeConfigured() {
  // A legacy static token or a store connected via OIDC (Vercel injects
  // VERCEL_OIDC_TOKEN per invocation; @vercel/blob resolves it against
  // BLOB_STORE_ID automatically) are both sufficient.
